...
\begin{tabular}{|c|c|c|}
	...
	\hline
t$\bar{t}$H	& 0.2151 & t$\bar{t}$H $\rightarrow$ W$^+$b W$^+$b WW $\rightarrow$ $\mu^+ \nu_\mu$b$\mu^- \bar{\nu_\mu}\bar{b}$ $\mu^+\mu^-$$\mu^+\mu^-$\\
\hline  
t$\bar{t}$W and &0.2043 &t$\bar{t}$W  $\rightarrow$  W$^+$b W$^+$b$\mu^+\mu^-$ $\rightarrow$$\mu \nu_\mu$b$\mu \nu_\mu$b$\mu^+\mu^-$\\
\hline
 t$\bar{t}$Z & 0.2529 & t$\bar{t}$Z  $\rightarrow$ W$^+$b  W$^-$$\bar{b}\mu^+ \mu^-$ $\rightarrow$ $\mu^+ \nu_\mu$b $\mu^- \bar{\nu_\mu} \bar{b}$  \\
 \hline 
  W$^+$W$^-$  &1.64 &WW$\rightarrow$$\mu^+ \mu^- \mu^- \mu^+$ \\
    \hline 
  tZq  &0.0758 & tZq$\rightarrow$W$^+$b$\mu^+ \mu^-$ q$\rightarrow$$\mu^+ \nu_\mu$b $\mu^+\mu^-$ q \\
    \hline 
  tttt  & 0.0091&tttt $\rightarrow$ W$^+$bW$^+$bW$^+$bW$^+$bW$^+$b $\rightarrow$ $\mu^+ \nu_\mu$b$\mu^+ \nu_\mu$b  q$\bar{q}$b q$\bar{q}$b \\
    \hline 
  WZZ  & 0.1651& WZZ$\rightarrow$ $\mu^+ \mu^- \mu^+ \mu^- l^+ l^-$\\
    \hline 
 ZZZ  &0.0139 & ZZZ$\rightarrow$ $\mu^+ \mu^-\mu^+ \mu^-l^+ l^-$  \\
    \hline 
  WZZ  & 0.0556&WZZ$\rightarrow$ $\mu^+ \mu^- \mu^+ \mu^- l^+l^-$ \\
  \hline 
 WZ &4.42965 &WZ$\rightarrow$ $\mu^+ \mu^- \mu^+ \mu^-$ \\
 \hline
...
\begin{minipage}{0.5\textwidth}
	\begin{center}
		\begin{figure}
			\includegraphics[width=6cm,height=5cm]{figures/kt-1/kin-kt-1.png}
...
\begin{minipage}{0.5\textwidth}
	\begin{center}
		\begin{figure}
			\includegraphics[width=6cm,height=5cm]{figures/kt-1/simple-kt-1.png}
...
\begin{center}
	\begin{tabular}{cc}
	\includegraphics[width=6cm,height=5cm]{figures/nos.png} & \includegraphics[width=5cm,height=5cm]{figures/normal-curve.jpg}
	\end{tabular}
\end{center}
\end{frame}
}
...
\begin{table}
	\caption*{Table for estimation of $\mu$ for fitting and upper limit with luminosity of 35.9 fb$^{-1}$}
	\begin{tabular}{|c|c|c|}
		\hline
		Model	&$\mu$ &$\mu$ upper limit  \\
		\hline
		SM ($K_t=1$)& 2.4975e+00 $\pm$ 1.29e+01&	28.047    \\
		\hline
	$K_t=-1$	& 6.9361e-02 $\pm$1.02e+00  &1.97 \\
		\hline
	\end{tabular}
\end{table}
\end{frame}
...
\nologo{
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[width=5.5cm,height=3cm]{figures/kin.png} &
...
\nologo{
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[width=5.5cm,height=3cm]{figures/kt-1/kin-kt-1.png} &
...
\nologo{
	...
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[width=5.5cm,height=3cm]{figures/kt-1/Likelihood-kt-1.png} &
...
\tiny{
	\begin{tabular}{|p{1cm}|c|c|c|c|}
		...
		\hline
		35.9 & 2.4975e+00 $\pm$ 1.29e+01 & 6.9361e-02 $\pm$1.02e+00&	28.047 & 1.97   \\
		\hline
		150& 1.0000e+00 +/-  6.44e+00 & 1.0000e+00 $\pm$  5.44e-01  &12.619 &0.915 \\
		\hline
		300&1.0000e+00 +/-  4.83e+00 &1.0000e+00 $\pm$  4.07e-01 & 9.427&0.649 \\
		\hline
		3000&1.0000e+00 $\pm$  1.54e+00 & 1.0000e+00 $\pm$  1.51e-01&	 3.442 & 0.25
		\\
		\hline
	\end{tabular}
}
