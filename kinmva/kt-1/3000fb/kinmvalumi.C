...
thq->Scale(18.48/thq->Integral());//thq
thw->Scale(7.72/thw->Integral());//thw
tzw->Scale(2.13/tzw->Integral());//tzw
zz->Scale(1.16/zz->Integral()); //zz

tzq->Scale(3000.0/35.9); //tzq
vvv->Scale(3000.0/35.9); //vvv
ww->Scale(3000.0/35.9); //wwss
tttt->Scale(3000.0/35.9); // tttt
fakes->Scale(3000.0/35.9); //non prompt
wz->Scale(3000.0/35.9); //WZ
ttz->Scale(3000.0/35.9);//ttZ
ttw->Scale(3000.0/35.9);//ttW
tth->Scale(3000.0/35.9);//tth
thq->Scale(3000.0/35.9);//thq
thw->Scale(3000.0/35.9);//thw
tzw->Scale(3000.0/35.9);//thw
zz->Scale(3000.0/35.9);//thw
...
hat->SetTitle("CMs preliminary Test               3000f/b ");
