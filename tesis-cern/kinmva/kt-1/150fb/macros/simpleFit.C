...
float i1 =(fakes->Integral())*(1.0+eps_fakes*alpha_fakes->getVal())*lumi->getVal();
float i2 =(tz->Integral())*(1.0+ eps_tz*alpha_tz->getVal())*lumi->getVal();
float i3=(wz->Integral())*(1.0+ eps_wz*alpha_wz->getVal())*lumi->getVal();
float i4=(ttz->Integral())*(1.0+ eps_ttz*alpha_ttz->getVal())*lumi->getVal();
float i5=(ttw->Integral())*(1.0+ eps_ttw*alpha_ttw->getVal())*lumi->getVal();
float i6=(th->Integral())*(alpha_mu->getVal())*lumi->getVal();
float i7=(tth->Integral())*(1.0+ eps_tth*alpha_tth->getVal())*lumi->getVal();
...
data1->SetTitle("CMs preliminary Test               150f/b (13TeV)");
