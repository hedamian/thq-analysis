...
void simpleFit2(string version, int strategy=0)
{
...
cout <<"error th  "<<th->Integral()*alpha_mu->getVal()<<endl;
cout <<"error th prefit   "<<th->Integral()*(sqrt(pow(0.037,2)+pow(0.04,2)))<<endl;
/////////////////////////////////////////////
...
legend1->AddEntry(th,"thq (k_{t}=-1)","f");
...
cs->SaveAs("simple-kt-1.png");  //Save to file
